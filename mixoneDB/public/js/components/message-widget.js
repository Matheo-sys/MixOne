  ...
  document.addEventListener('DOMContentLoaded', function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              /* eslint-disable */(_console = console).error.apply(_console, _toConsumableArray(oo_tx("503832055_96_20_96_73_11", 'Erreur lors de la recherche :', _context.t0)));
            case 13:
            case "end":
    ...
    function renderSearchResults(users) {
      searchResults.innerHTML = users.length === 0 ? '<div class="text-center py-15 text-light-1">Aucun utilisateur trouvé</div>' : users.map(function (user) {
        return "\n                    <div class=\"conversation-item js-start-chat\" data-id=\"".concat(user.id, "\" data-name=\"").concat(user.first_name, " ").concat(user.last_name, "\" data-avatar=\"").concat(user.avatar, "\" style=\"padding: 10px 20px; display: flex; align-items: center; border-bottom: 1px solid #f0f0f0; cursor: pointer;\">\n                        <img src=\"").concat(user.avatar ? '/storage/' + user.avatar : '/media/img/misc/avatar-default.png', "\" style=\"width: 35px; height: 35px; border-radius: 50%; object-fit: cover; margin-right: 12px;\">\n                        <span style=\"font-weight: 500; color: #051036; font-size: 14px;\">").concat(user.first_name, " ").concat(user.last_name, "</span>\n                    </div>\n                ");
      }).join('');
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 12:
              ...
              /* eslint-disable */(_console3 = console).error.apply(_console3, _toConsumableArray(oo_tx("503832055_150_16_150_68_11", 'Erreur chargement messages :', _context3.t0)));
            case 15:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 11:
              ...
              /* eslint-disable */(_console4 = console).error.apply(_console4, _toConsumableArray(oo_tx("503832055_170_16_170_63_11", 'Erreur nombre non lus :', _context4.t0)));
            case 14:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 6:
              ...
              /* eslint-disable */(_console5 = console).error.apply(_console5, _toConsumableArray(oo_tx("503832055_188_16_188_65_11", 'Erreur lecture messages :', _context5.t0)));
            case 9:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 7:
              ...
              /* eslint-disable */(_console6 = console).error.apply(_console6, _toConsumableArray(oo_tx("503832055_209_16_209_70_11", 'Erreur masquage conversation :', _context6.t0)));
            case 10:
            case "end":
    ...
    sendForm.addEventListener('submit', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var _messages$find;
        var text, receiverId, nowIso, originalMessageText, msgIndex, currentEditId, endpoint, method, response, _msgIndex, _console2;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 26:
              ...
              /* eslint-disable */(_console2 = console).error.apply(_console2, _toConsumableArray(oo_tx("503832055_423_16_423_65_11", 'Erreur lors de l\'envoi :', _context2.t0)));
              _context2.next = 31;
              return loadMessages();
            case 31:
              renderMessages(parseInt(receiverId));
