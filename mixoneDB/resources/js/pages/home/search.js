    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.changeHours = function(amount) {
            ...
            if (!isNaN(currentValue)) {
                ...
                document.querySelectorAll('input[name="min_hours"]').forEach(el => el.value = currentValue);
            }
        };
        ...
        document.addEventListener('input', function(e) {
            if (e.target.name === 'city') {
                ...
                document.querySelectorAll('input[name="latitude"]').forEach(el => el.value = '');
                document.querySelectorAll('input[name="longitude"]').forEach(el => el.value = '');
