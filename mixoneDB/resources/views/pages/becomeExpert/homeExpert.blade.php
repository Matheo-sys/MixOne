<section class="mt-90 section-bg layout-pt-xl layout-pb-xl relative flex-center" style="min-height: 400px; background-image: url('{{ asset('media/img/backgrounds/11.jpg') }}'); background-size: cover; background-position: center; background-attachment: fixed;">
        ...
        <div class="row justify-center text-center">
            <div class="col-xl-8 col-lg-10">
                ...
                <div class="d-inline-block mt-40 md:mt-30">
                    <a href="/register" class="button -md px-30 h-60 bg-blue-1 text-white fw-600 rounded-8 transition flex-center hover:opacity-80">
                        Inscription <i class="icon-arrow-top-right text-16 ml-10"></i>
                    </a>
                </div>
            </div>
        </div>
