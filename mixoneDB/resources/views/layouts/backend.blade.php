...
<head>
    ...
    <meta property="og:image" content="{{ secure_asset('media/img/general/og-image-v4.png') }}">
    ...
    <meta property="twitter:image" content="{{ secure_asset('media/img/general/og-image-v4.png') }}">
