            ...
            <div class="col-auto">
                <div class="d-flex items-center">
                    <a href="index.html" class="header-logo mr-20" data-x="header-logo" data-x-toggle="is-logo-dark">
                        <img src="Logo_white.png" alt="logo icon">
                        <img src="Logo_white.png" alt="logo icon">
                    </a>
            ...
            <div class="col-auto">
                <div class="d-flex items-center">
                    ...
                    <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                        <a href="become-expert.html" class="button px-30 fw-400 text-14 -white bg-white h-50 text-dark-1">Devenez un Studio Confirmé</a>
                        <a href="login.html" class="button px-30 fw-400 text-14 border-white -outline-white h-50 text-white ml-20">Inscription / Se connecter</a>
                    </div>
                    ...
                    @else
                        <div class="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                            <a href="#"
                               ...
                               class="button px-30 fw-400 text-14 border-white -outline-white h-50 text-white ml-20">Déconnexion</a>
                        </div>
