                    ...
                    <div class="row items-center x-gap-5 y-gap-20 pl-20 lg:d-none">
                        ...
                        <div class="pl-15">
                            <div class="size-50 rounded-22 overflow-hidden">
                                <img src="{{ auth()->user()->avatar ? storage_url(auth()->user()->avatar) : asset('media/img/misc/avatar-default.png') }}" alt="image" class="size-50 object-cover" style="transform: scale(1.3);">
                            </div>
                        </div>
                    </div>
                </div>
