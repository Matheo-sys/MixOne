<div class="dashboard__sidebar bg-white scroll-bar-1">
    ...
    <div class="sidebar -dashboard">
        ...
        <div class="sidebar__item ">
            ...
            <a href={{route("dashboard.studio")}} class="sidebar__button d-flex items-center text-15 lh-1 fw-500">
        ...
        <div class="sidebar__item ">
            ...
            <a href={{route('dashboard.studio.booking')}} class="sidebar__button d-flex items-center text-15 lh-1 fw-500">
                ...
                <div class="accordion__item">
                    ...
                    <div class="accordion__content">
                        <ul class="list-disc pt-15 pb-5 pl-40">
                            ...
                            <li>
                                <a href={{route('dashboard.studio.myStudios')}} class="text-15">Tous mes studios</a>
                            </li>

                            <li>
                                <a href={{route('dashboard.studio.create')}} class="text-15">Ajouter un studio</a>
                            </li>
